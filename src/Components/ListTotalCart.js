...
export const ListTotalCart = () => {
    ...
    return (
        <div>
            ...
            <hr />
            <ul className=" overflow-y-scroll h-[505px]">
                    ...
                    return (
                        <li key={index} className="flex items-center justify-between">
                            ...
                            <div className="grid grid-cols-3 gap-2 mr-4">
                                ...
                                <button className=" bg-rose-400 w-8 h-8 rounded-2xl flex items-center justify-center relative"><h3 className="text-2xl font-bold absolute top-[-2px] text-white" onClick={() => dispatch(count({ name: item.name, price: 0, type: 'remove' }))}>-</h3></button>
                            </div>
